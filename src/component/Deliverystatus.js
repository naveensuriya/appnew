...
adminhome.length !=0 && 
    ...
    <Card.Body>
      ...
      {
          obj.cart.map((obj,index)=><Row className="h5">
...
homeorder.length !=0 && 
    ...
    homeorder.map((obj,index)=><Col md={6} className="mt-3" ><Card key={index} className="ordercard">
    <Card.Body>
      <Card.Title><h4 className="text-center">Order ID : {obj._id}</h4></Card.Title>
      <Card.Text>
        <hr/>
...
takeawayorder.length !=0 && 
    ...
    takeawayorder.map((obj,index)=><Col md={6} className="mt-3" ><Card key={index} className="ordercard">
    <Card.Body>
      <Card.Title><h4 className="text-center">Order ID : {obj._id}</h4></Card.Title>
      <Card.Text>
        <hr/>
